...
class VideoPlayer extends Component {
  ...
  constructor(props) {
    ...
    this.events = {
      ...
      onBuffer: this._onBuffering.bind(this),
  ...
  _onBuffering() {
    ...
    if (typeof this.props.onBuffer === 'function') {
      this.props.onLoadStart(...arguments);
    }
  }
  ...
  _onLoad(data = {}) {
    ...
    this.props.postVideoState(login.data.id, 'start');
  ...
  _togglePlayPause() {
    ...
    if (state.paused) {
      ...
      this.props.postVideoState(login.data.id, 'pause');
    } else {
   ...
   */
  render() {
    const url = this.props.navigation.getParam('url', 'kcbkdjb');
      ...
      <TouchableWithoutFeedback
        ...
        <View style={[styles.player.container, this.styles.containerStyle]}>
          <Video
            ...
            //   isBuffering ? showHUD('Cargando..') : hideHUD()
            // }
            // bufferConfig={{
            //   minBufferMs: 15000,
            //   maxBufferMs: 50000,
...
export default connect(mapStateToProps, {postVideoState})(VideoPlayer);
